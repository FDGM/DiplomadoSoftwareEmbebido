...
{ .channel = 10, .trigger = EXTERNAL_IRQ_TRIG_RISING, .filter_enable = false, .pclk_div = EXTERNAL_IRQ_PCLK_DIV_BY_64,
  .autostart = true, .p_callback = button_callback_SW5, .p_context = &g_external_irq10, .p_extend = NULL, .irq_ipl =
          (12), };
...
{ .channel = 9, .mode = INPUT_CAPTURE_MODE_PERIOD, .edge = INPUT_CAPTURE_SIGNAL_EDGE_RISING, .repetition =
  ...
  .autostart = true, .p_callback = cb_input_capture, .p_context = &g_input_capture, .p_extend = &g_input_capture_extend,
